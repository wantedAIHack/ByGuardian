...
class QuestionRewritePromptTest {
    ...
    void sendsOnlyRankAndTemplateSentence() throws Exception {
        ...
        LlmPrompt prompt = promptBuilder.build(List.of(input), Optional.empty());
    ...
    void retryAddsOnlyTheRuleNameAndKeepsTheSameUserJson() {
        ...
        LlmPrompt first = promptBuilder.build(List.of(input), Optional.empty());
        LlmPrompt retry = promptBuilder.build(
